...
function getList($type, $shop_type){
	$url = 'http://api-wx.firstblog.cn/case/lists1?type=tasks&page=1&shop_type=tb&consumer_id=25471';
...
function prompt($name,$task){
	echo '13367717674接到任务'.$name.' 佣金：'.$task->money.'   任务id：'.$task->id.'  店铺名：'.$task->name;
...
function post($url, $fields){
	...
	$header = array('token:eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0aW1lIjoxNTcwNjgyMzYxLCJ1c2VyIjoiMzM5OTUifQ.7O7ILLx4keuXU-rvLq9D_DE9r_BujiaqKksUzYO2a9g');
