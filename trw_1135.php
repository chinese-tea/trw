...
function getList($type, $shop_type){
	$url = 'http://api-wx.firstblog.cn/case/lists1?type=tasks&page=1&shop_type=tb&consumer_id=25508';
...
function prompt($name,$task){
	echo '15277041135接到任务'.$name.' 佣金：'.$task->money.'   任务id：'.$task->id.'  店铺名：'.$task->name;
...
function post($url, $fields){
	...
	$header = array('token:eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0aW1lIjoxNTcwNjY5OTk5LCJ1c2VyIjoiMzM4ODMifQ.PWvxh3CXHDGhvPqEjWQh8jlf0xnvDFh033dgW6HJwos');
